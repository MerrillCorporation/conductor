...
public abstract class ClientBase {
    ...
    protected String useExternalPayloadStorage(String uri, byte[] jsonBytes, long payloadSize) {
        ...
        payloadStorage.upload(externalStorageLocation.getUri(), new ByteArrayInputStream(jsonBytes), payloadSize);
